...
class MyoRaw(object):
    ...
    def __init__(self, tty=None):
        ...
        self.arm_handlers = []
        self.pose_handlers = []
        rospy.init_node("myo_node")
        self.roll_pub = rospy.Publisher('myo_roll', Float32)
        self.pitch_pub = rospy.Publisher('myo_pitch', Float32)
        self.yaw_pub = rospy.Publisher('myo_yaw', Float32)
    ...
    def connect(self):
        ...
        def handle_data(p):
            ...
            if attr == 0x27:
                ...
                roll = euler[0] * 180.000 / 3.14159
                pitch = euler[1] * 180.000 / 3.14159 + 90
                yaw = euler[2] * 180.000 / 3.14159
